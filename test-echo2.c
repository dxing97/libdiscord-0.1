...
/* LOG_PERROR is not POSIX standard, and may not be portable */
	...
	char passphrase[256];
	char uri[256] = "/?encoding=json&v=6";
#ifndef LWS_NO_CLIENT
	char address[256] = "gateway.discord.gg", ads_port[256 + 30];
	int rate_us = 25000000;
...
// #ifndef LWS_NO_CLIENT
		case 'c': //run as client and connect to this address, get from discord API and not command line
			...
			port = 443; //change port based on gateway URL - probably 443 for WSS
			break;
